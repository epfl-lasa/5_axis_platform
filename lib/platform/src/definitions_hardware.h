...
#define PRESENCE_FORCE_SENSOR WITH_FORCE_SENSOR
...
const float INV_TORQUE_K[] = {1.0f / TORQUE_K[Y], 1.0f / TORQUE_K[X], 1.0f / TORQUE_K[PITCH],1.0f / TORQUE_K[ROLL], 1.0f / TORQUE_K[YAW]};
