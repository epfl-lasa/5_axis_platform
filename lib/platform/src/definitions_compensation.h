...
float const GRAVITY_EFFORT_LIMS[NB_LIMS][NB_AXIS] = {{0.0f, 0.0f, -3.0f, -3.0f, -3.0f}, {0.0f, 0.0f, 3.0f, 3.0f, 3.0f}};
float const INERTIA_EFFORT_LIMS[NB_LIMS][NB_AXIS] = {{-10.0f,-10.0f,-1.0f,-1.5f,-1.5f}, {10.0f, 10.0f, 1.0f, 1.5f, 1.5f}};
float const CORIOLIS_EFFORT_LIMS[NB_LIMS][NB_AXIS] = {{-10.0f,-10.0f,-1.0f,-1.5f,-1.5f}, {10.0f, 10.0f, 1.0f, 1.5f, 1.5f}};
...
float const FS_EFFORT_LIMS[NB_LIMS][NB_AXIS] =  {{-17.0f, -17.0f , -3.0f, -3.0f, -3.0f}, {17.0f, 17.0f, 3.0f, 3.0f,3.0f}};                                                             
