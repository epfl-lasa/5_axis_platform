...
const float C_WS_LIMIT_Y = (Y_RANGE / 2.0f) * 0.5f;
const float C_WS_LIMIT_X = (X_RANGE / 2.0f) * 0.5f;
const float C_WS_LIMIT_PITCH = (PITCH_RANGE / 2.0f) * 0.5f;
const float C_WS_LIMIT_ROLL = (ROLL_RANGE / 2.0f) * 0.41f;
const float C_WS_LIMIT_YAW = (YAW_RANGE / 2.0f) * 0.81f;
