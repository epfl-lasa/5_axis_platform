...
//*************************MOTION_DAMPING****AKA.SUPRESS_TREMOR****************************
        ...
        #define MOTION_DAMPING_KP_SPEED_YAW 170.0f * SCALE_GAINS_ANGULAR_SPEED       //[Nm/deg.s]            
           ...
           //***************************SHOULD-BE-ZERO****************/             
            ...
            #define MOTION_DAMPING_KI_SPEED_X  0.0f                                 //[N.s/m.s]
            #define MOTION_DAMPING_KI_SPEED_Y  0.0f                                 //[N.s/m.s]
            #define MOTION_DAMPING_KI_SPEED_PITCH  0.0f                             //[N.s/deg.s]
            #define MOTION_DAMPING_KI_SPEED_ROLL  0.0f                              //[N.s/deg.s]
            #define MOTION_DAMPING_KI_SPEED_YAW 0.0f                                //[N.s/deg.s]

            #define MOTION_DAMPING_KD_SPEED_YAW 0.0f                                //[N.s/m] 
            #define MOTION_DAMPING_KD_SPEED_X  0.0f                                 //[N.s/m]
            #define MOTION_DAMPING_KD_SPEED_Y  0.0f                                 //[Nm.s/deg]
            #define MOTION_DAMPING_KD_SPEED_PITCH  0.0f                             //[Nm.s/deg]
            #define MOTION_DAMPING_KD_SPEED_ROLL  0.0f                              //[Nm.s/deg]
